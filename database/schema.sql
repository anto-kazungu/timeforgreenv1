-- ============================================
-- timeforgreen Database Schema - Fixed Version
-- PostgreSQL 15+
-- ============================================
...
CREATE TRIGGER trg_modules_updated_at BEFORE UPDATE ON training_modules
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER trg_projects_updated_at BEFORE UPDATE ON donation_projects
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
